...
Project Status
This repository is currently in the requirements and architecture planning stage. 

Next actions:

Record architecture decisions for the final stack.
Define the domain model, database schema, and API surface.
Create the monorepo skeleton, CI/CD, and security baseline.
Design the Task Workspace and Group Chat user flows.
Implement the Phase 1 authentication and collaboration foundation.
